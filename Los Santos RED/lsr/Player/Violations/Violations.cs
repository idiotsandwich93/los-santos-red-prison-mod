...
namespace LosSantosRED.lsr
{
    ...
    public class Violations
    {
        ...
        // While serving a prison sentence the inmate is authorized to be inside the prison: this is the
        // single chokepoint that clears the restricted-area state, unlocks the gates, suppresses the
        // security-camera report, and blocks every trespassing crime (incl. "Trespassing on Government
        // Property" from the IsRestrictedDuringWanted JAIL zone). Scoped strictly to incarceration.
        public bool CanEnterRestrictedAreas => Player.IsCop || Settings.SettingsManager.ViolationSettings.TreatAsCop || EntryPoint.PlayerIsIncarcerated;
