...
public class OtherViolations
{
    ...
    {
        if (!Violations.CanEnterRestrictedAreas && !EntryPoint.PlayerIsIncarcerated && Player.IsWanted && Player.CurrentLocation != null && Player.CurrentLocation.CurrentZone != null && Player.CurrentLocation.CurrentZone.IsRestrictedDuringWanted && Player.CurrentLocation.GameTimeInZone >= 15000 && (Player.WantedLevel >= 2 || Player.PoliceResponse.IsDeadlyChase))
        {
