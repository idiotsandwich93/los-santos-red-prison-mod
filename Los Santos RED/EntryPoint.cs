...
public static class EntryPoint
{
    ...
    // True while the player is serving a prison sentence; lets vanilla prison scenario peds populate the yard.
    public static bool PlayerIsIncarcerated { get; set; } = false;
